...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  void updateAttendanceField(int index, String field, dynamic value) {
    setState(() {
      final updatedAttendance = attendanceData[index].copyWith(
        checkInTime:
            field == 'checkInTime' ? value : attendanceData[index].checkInTime,
        checkOutTime: field == 'checkOutTime'
            ? value
            : attendanceData[index].checkOutTime,
        status: field == 'status' ? value : attendanceData[index].status,
        remarks: field == 'remarks' ? value : attendanceData[index].remarks,
      );
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              onChanged: (value) => onFieldUpdated('status', value),
